...
class CashCardApplicationTests {
    ...
    void shouldNotReturnACashCardWhenUsingBadCredentials() {
        ResponseEntity<String> responseWithBadUser = restTemplate
                .withBasicAuth("BAD-USER", "abc123")
                .getForEntity("/cashcards/99", String.class);
        assertThat(responseWithBadUser.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);

        ResponseEntity<String> responseWithBadPassword = restTemplate
                .withBasicAuth("sarah1", "BAD-PASSWORD")
                .getForEntity("/cashcards/99", String.class);
        assertThat(responseWithBadPassword.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
    ...
    void shouldNotUpdateACashCardThatDoesnotExist() {
        CashCard cashCard = new CashCard(null, 99.23, null);
    ...
    void shouldNotUpdateACashCardThatIsOwnedBySomeoneElse() {
        CashCard kumarsCard = new CashCard(null, 231.11, null);
